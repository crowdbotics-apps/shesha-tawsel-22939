"""shesha_tawsel_22939 URL Configuration
...
admin.site.site_header = "shesha tawsel"
admin.site.site_title = "shesha tawsel Admin Portal"
admin.site.index_title = "shesha tawsel Admin"

# swagger
api_info = openapi.Info(
    title="shesha tawsel API",
    default_version="v1",
    description="API documentation for shesha tawsel App",
)
